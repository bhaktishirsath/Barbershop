...
function displayhotelroom(){
  Room_cart.forEach((products)=>{
   ...
   ` <div class="room__grid col-md-4 col-lg-3 d-flex d-flex-wrap   "  style="background-color: white; border-radius:20px ;padding:9px;">
    ...
    <div class="room__card row">
      ...
      <h5>strating from $<span>${products.price}/night</span></h5>
